...
import (
	...
	"github.com/akhripko/dummy/src/srv/srvgql/models"
...
func (ec *executionContext) _Message_error(ctx context.Context, field graphql.CollectedField, obj *models.Message) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalOError2ᚖgithubᚗcomᚋakhripkoᚋdummyᚋsrcᚋsrvᚋsrvgqlᚋmodelsᚐError(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_hello(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNMessage2ᚖgithubᚗcomᚋakhripkoᚋdummyᚋsrcᚋsrvᚋsrvgqlᚋmodelsᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMessage2githubᚗcomᚋakhripkoᚋdummyᚋsrcᚋsrvᚋsrvgqlᚋmodelsᚐMessage(ctx context.Context, sel ast.SelectionSet, v models.Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚖgithubᚗcomᚋakhripkoᚋdummyᚋsrcᚋsrvᚋsrvgqlᚋmodelsᚐMessage(ctx context.Context, sel ast.SelectionSet, v *models.Message) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOError2githubᚗcomᚋakhripkoᚋdummyᚋsrcᚋsrvᚋsrvgqlᚋmodelsᚐError(ctx context.Context, sel ast.SelectionSet, v models.Error) graphql.Marshaler {
	return ec._Error(ctx, sel, &v)
}

func (ec *executionContext) marshalOError2ᚖgithubᚗcomᚋakhripkoᚋdummyᚋsrcᚋsrvᚋsrvgqlᚋmodelsᚐError(ctx context.Context, sel ast.SelectionSet, v *models.Error) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Error(ctx, sel, v)
